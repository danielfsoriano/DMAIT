...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <identifier>mtype645</identifier>
    ...
    <mote>
      ...
      <motetype_identifier>mtype645</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/COMPARISON-JAMIL,ALI,ALKHALEC/TEST1-12x1-JAMIL,ALI,ALKHALEC-DMAIT-SEED2-log.txt";// path to log file
log.writeFile(path, "");
...
attacks.push(new Attack("SFA_on", 2, 120000, 1800000)); //starts after 100 sec
attacks.push(new Attack("SFA_on", 3, 120000, 1800000)); //starts after 100 sec

...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/16x2-GRID-SPARSE/DMAIT/TEST1-16x2-GRID-SPARSE-DMAIT-SEED10-log.txt";// path to log file
log.writeFile(path, "");

...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/16x2-GRID-SPARSE/BASELINE/TEST1-16x2-GRID-SPARSE-BASELINE-SEED14-log.txt";// path to log file
log.writeFile(path, "");

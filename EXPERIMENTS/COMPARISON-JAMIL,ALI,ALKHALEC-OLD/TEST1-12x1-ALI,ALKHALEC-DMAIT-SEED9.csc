...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/COMPARISON-ALI,ALKHALEC/TEST1-12x1-ALI,ALKHALEC-DMAIT-SEED9-log.txt";// path to log file
log.writeFile(path, "");

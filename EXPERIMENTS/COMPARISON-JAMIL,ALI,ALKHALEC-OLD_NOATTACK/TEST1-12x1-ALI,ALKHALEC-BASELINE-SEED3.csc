...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/COMPARISON-JAMIL,ALI,ALKHALEC-OLD_NOATTACK/TEST1-12x1-ALI,ALKHALEC-BASELINE-SEED3-log.txt";// path to log file
log.writeFile(path, "");

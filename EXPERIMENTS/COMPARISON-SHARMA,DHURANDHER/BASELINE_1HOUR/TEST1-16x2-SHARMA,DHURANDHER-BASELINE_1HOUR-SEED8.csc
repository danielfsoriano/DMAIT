...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/COMPARISON-SHARMA,DHURANDHER/BASELINE_1HOUR/TEST1-16x2-SHARMA,DHURANDHER-BASELINE_1HOUR-SEED8-log.txt";// path to log file
log.writeFile(path, "");

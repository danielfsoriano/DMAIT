...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/COMPARISON-SHARMA,DHURANDHER/DMAIT_1HOUR/TEST1-16x2-SHARMA,DHURANDHER-DMAIT_1HOUR-SEED5-log.txt";// path to log file
log.writeFile(path, "");

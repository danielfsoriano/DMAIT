...
path = "/home/user/contiki-ng/examples/EXPERIMENTS/16x2-GRID-DENSE/DMAIT/TEST1-16x2-GRID-DENSE-DMAIT-SEED7-log.txt";// path to log file
log.writeFile(path, "");

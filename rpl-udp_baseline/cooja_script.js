sim.setSpeedLimit(10.0); // set simulation speed to real time (1x)
path = "/home/user/contiki-ng/examples/5tree_baseline_log.txt";// path to log file
log.writeFile(path, "");
...
attacks = new Array();
attacks.push(new Attack("SFA_on", 2, 300000, 3600000)); //starts at 5 min
attacks.push(new Attack("SFA_on", 8, 300000, 3600000)); //starts at 5 min

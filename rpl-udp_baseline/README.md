This is a modification of the RPL UDP Comunication example, that comes with Contiki.
It has been enhanced with added output and optional ACKs for Data Messages (that are not
validated, they're used only to generate traffic).
